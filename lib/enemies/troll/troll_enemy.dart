...
import 'package:tibia_mobile/enemies/troll/troll_scrite.dart';

class TrollEnemy extends SimpleEnemy with BlockMovementCollision, UseLifeBar {
  JoystickMoveDirectional _movingDirection = JoystickMoveDirectional.IDLE;
  Vector2? _targetPosition;
  double _idleTimer = 0;

  TrollEnemy({required super.position})
    : super(size: Vector2(64, 64), speed: 30, life: 100) {
    TrollSprite.animation.then((anim) => animation = anim);
  }
